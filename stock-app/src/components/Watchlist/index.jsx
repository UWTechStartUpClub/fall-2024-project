...
const Watchlist = () => {
    ...
    const [stockList, setStockList] = useState([]); // hold response data for the user's stocks
                            ...
                            <div className={style.listGrid}>
                                <div>
                                    <span className={style.stockError}>
                                        Error (on {listing.symbol}) - {listing.error.message}
                                    </span>
                                </div>
